 ...
 *
 * The iteratee will be run sequentially. As opposed to findIndex() and findIndexLimit() this ensures
 ...
 */
export default async function findIndexSeries (iterable, iteratee) {
